const quests = [
    {
        statement: "1. Onde você deve buscar abrigo se sua casa for afetada por uma enchente?",
        answers: [
    ...
    {
        statement: "2. O que você deve fazer com os aparelhos elétricos durante uma enchente?",
        answers: [
    ...
    {
        statement: "3. É seguro andar ou dirigir por áreas alagadas?",
        answers: [
    ...
    {
        statement: "4. Qual documento é importante ter sempre à mão em caso de emergência?",
        answers: [
    ...
    {
        statement: "5. O que você deve evitar consumir após uma enchente?",
        answers: [
    ...
    {
        statement: "6. Qual o melhor kit de emergência para ter em casa?",
        answers: [
    ...
    {
        statement: "7. Onde você deve descartar lixo e objetos que foram atingidos pela enchente?",
        answers: [
    ...
    {
        statement: "8. É seguro usar a rede elétrica logo após a água da enchente baixar?",
        answers: [
    ...
    {
        statement: "9. O que você deve fazer se precisar evacuar sua casa?",
        answers: [
    ...
    {
        statement: "10. Qual o número de emergência que você deve ligar em caso de enchente grave?",
        answers: [
